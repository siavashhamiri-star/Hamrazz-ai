    ...
    <div className="space-y-8">
        ...
        <Alert variant="default" className="border-blue-500/50 bg-blue-500/10 text-blue-700 dark:text-blue-300">
         ...
         <Alert variant="default" className="border-purple-500/50 bg-purple-500/10 text-purple-700 dark:text-purple-300">
            ...
            <AlertDescription>
                Once Hamraz reaches 500,000 downloads, 40% of the app's revenue from advertising and payments from platforms like Google will be converted into "revenue shares." These shares, representing a perpetual income stream, will be awarded to premium users, contest winners, and creators of viral content. Furthermore, a select group of loyal and active users will form an Online Advisory Council, holding tri-monthly meetings with voting rights on policy and overseeing the distribution of the 40% revenue share on behalf of the entire community.
            </AlertDescription>
        </Alert>
