    ...
    <div className="max-w-5xl mx-auto space-y-12 pb-20 pt-8 px-4">
      ...
      <Card className="relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-card to-primary/5 shadow-2xl">
        ...
        <CardContent className="p-8 md:p-12">
          <div className="prose prose-xl dark:prose-invert max-w-none text-right leading-relaxed space-y-8" dir="rtl">
            ...
            <p>
              در "همراز"، هر فعالیت شما، از یادگیری زبان تا خلق محتوا و برنده شدن در مسابقات، به دارایی‌های دیجیتال واقعی و قطعات زمین در این شهر رویایی تبدیل می‌شود. ما <span className="text-primary font-bold">سیستم دموکراسی ثروت و قدرت</span> را پیاده کرده‌ایم؛ جایی که فعال‌ترین شهروندان و خلاق‌ترین ذهن‌ها، نه تنها پاداش می‌گیرند، بلکه بر صندلی‌های شورای سیاست‌گذاری تکیه می‌زنند و در سود کلان این انقلاب بزرگ شریک می‌شوند.
            </p>
            <p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          { icon: TrendingUp, title: "دموکراسی ثروت", desc: "توزیع عادلانه سود تبلیغات و ارزش زمین‌های دیجیتال." },
