  ...
  return (
    <div className="space-y-8">
      <Alert variant="default" className="bg-accent/10 border-accent/30">
        ...
        <AlertDescription>
          Have you turned an idea into reality, found a collaborator, or reached a milestone using our platform? Share your story! Selected videos will be featured on our social media channels, provided you are a member of our channel on that platform.
        </AlertDescription>
      </Alert>
      ...
      <Card className="w-full max-w-2xl mx-auto shadow-lg" id="submit-story">
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>Your video may be shared on our YouTube, Instagram, or TikTok, provided you are a member of our channel on that platform.</CardDescription>
          </CardHeader>
