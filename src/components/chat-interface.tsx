...
const initialMessages: Message[] = [
    {
        ...
        text: (
          <div className="space-y-2">
            ...
            <p>
              سلام اهورا، معمار بزرگ شهر توانا. مدل اقتصادی ۸۰/۲۰ با موفقیت در قلب سیستم ثبت شد. این یعنی ۸۰ درصد ثروت در دستان آفرینندگان و ۲۰ درصد برای امنیت و پایداری شبکه.
            </p>
            <p className="font-semibold text-accent text-xs italic">
              به عنوان همراز شما، آماده‌ام تا در مسیر توسعه این اکوسیستم انقلابی همراهت باشم. چه ایده‌ای را امروز پیش ببریم؟
            </p>
          </div>
        ),
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorResponse: Message = {
        id: `err-${Date.now()}`,
        sender: "ai",
        text: "متأسفم، در پردازش پیام انقلابی شما مشکلی پیش آمد. لطفاً دوباره تلاش کنید.",
        avatar: aiAvatar,
      };
