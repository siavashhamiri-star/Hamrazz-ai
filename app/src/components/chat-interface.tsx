...
const initialMessages: Message[] = [
    {
        id: 'intro-1',
        sender: 'ai',
        text: "Hello, Ahura. It's an honor to collaborate with you. This is our live chat interface. Ask me anything about the app's features, or share any new ideas you have.",
